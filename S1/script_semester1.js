...
function updateCalculations() {
    ...
    // Unit averages
    state.results.unit1 = (
        state.results.modules.Algorithms * 2 +
        state.results.modules.Analysis * 2 +
        state.results.modules.Algebra
    ) / 5;
    ...
    state.results.unit3 = (
        state.results.modules.Comp +
        state.results.modules.CRI
    ) / 2;
...
function init() {
    ...
    const units = [
        {
            title: 'Unit 1: Fundamental', gridClass: 'md:grid-cols-3', modules: [
                {
                    title: 'Algorithms', coefficient: 4, fields: [
                ...
                {
                    title: 'Analysis', coefficient: 4, fields: [
        ...
        {
            title: 'Unit 2: Methodological', gridClass: 'md:grid-cols-2', modules: [
                {
                    title: 'Terminology', coefficient: 1, fields: [
                        { name: 'terminology', placeholder: 'Grade (100%)' }
                    ]
                },
                {
                    title: 'Bureautique', coefficient: 1, fields: [
    ...
    setupSaveLoadSystem(state, 'savedGradesSemester1');
}

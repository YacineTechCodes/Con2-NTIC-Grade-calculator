...
function init() {
    ...
    unitSections.appendChild(createUnit({
        ...
        modules: [
            {
                title: 'Algorithms & Data Structures', coefficient: 3, fields: [
            ...
            {
                title: 'Computer Architecture', coefficient: 2, fields: [
                    { name: 'compArchControl', placeholder: 'Control (67%)' },
                    { name: 'compArchTp', placeholder: 'TP (33%)' }
                ]
            },
            {
                title: 'Mathematical Logic', coefficient: 2, fields: [
    ...
    unitSections.appendChild(createUnit({
        ...
        modules: [
            {
                title: 'Object-Oriented Programming', coefficient: 3, fields: [
            ...
            {
                title: 'Information Systems', coefficient: 3, fields: [
                    { name: 'infoSysControl', placeholder: 'Control (67%)' },
                    { name: 'infoSysTd', placeholder: 'TD (33%)' }
                ]
            },
            {
                title: 'Language Theory', coefficient: 2, fields: [
